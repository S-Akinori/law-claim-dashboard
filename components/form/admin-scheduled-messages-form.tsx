'use client'
import { insertScheduledMessage, updateScheduledMessage } from "@/app/actions/admin/scheduled-messages"
...
interface AdminScheduledMessageFormProps {
    scheduledMessageData?: Tables<"master_scheduled_messages">
}

function AdminScheduledMessageForm({ scheduledMessageData }: AdminScheduledMessageFormProps) {
...
export default AdminScheduledMessageForm